...
The Authoring Workbench is shipped, so Composite Environment Presets is the next available optional-tooling work. The V1 critical-path next action remains `/implement pantry_presentation_01`.
